...
- [x] **BL-005** — Decided 2026-08-25: **personal accounts**, same as ChefMate/ChefCellar — GitHub `lbk-3344`, Vercel "ChefMate" team (`team_jVWZVRFpRFpbLSAiWG7RchQb`). Staging+main branch model as-is. Neon project to be created by Luc (no Neon MCP/CLI access from either side yet) — connection string to follow.
