...
- **`PUT /collectors/{collectorId}/heartbeat`**, **`POST /reads`** — heartbeat keepalive and tag-observation ingestion. Not modeled by this app — no simulated "send" capability exists (see section 15's manual-send scoping note), and this stays true even after 15.8's registration integration.
